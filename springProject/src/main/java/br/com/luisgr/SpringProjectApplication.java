...
import br.com.luisgr.model.bookmarks.Account;
import br.com.luisgr.model.bookmarks.AccountRepository;
import br.com.luisgr.model.bookmarks.Bookmark;
import br.com.luisgr.model.bookmarks.BookmarkRepository;
	...
	public BookmarkResource(Bookmark bookmark) {
		...
		this.add(linkTo(
				methodOn(BookmarkRestController.class, username).readBookmark(
						null, bookmark.getId())).withSelfRel());
	}
